...
* @package    gwreports
* @version    $Id: editparameter.php 51 2013-04-06 22:31:57Z rgriffith $
*/
...
$parameter_id=0;
    if (isset($_GET['pid'])) {
        $parameter_id = intval($_GET['pid']);
    }
    if (isset($_POST['pid'])) {
        $parameter_id = intval($_POST['pid']);
    }
...
//	if(isset($_POST['parameter_sqlchoice'])) $parameter_sqlchoice = cleaner($_POST['parameter_sqlchoice']);
    ...
    if (isset($_POST['parameter_length'])) {
        $parameter_length = abs(intval($_POST['parameter_length']));
    }
    if ($parameter_length==0) {
        $parameter_length=20;
    }
    if (isset($_POST['parameter_decimals'])) {
        $parameter_decimals = abs(intval($_POST['parameter_decimals']));
    }
